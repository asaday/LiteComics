...
type Config struct {
	...
	AllowFileOperations *bool                               `json:"allowFileOperations,omitempty"` // Allow file/folder mutation operations
	AllowUpload         *bool                               `json:"allowUpload,omitempty"`         // Allow browser uploads
