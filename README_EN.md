...
### Features
- **Multiple Format Support**: CBZ, ZIP, CBR, RAR, CB7, 7Z, EPUB (image extraction)
...
├── src/               # Go server implementation
│   ├── main.go        # Entry point
│   ├── main_gui.go    # GUI version (macOS/Windows)
│   ├── server.go      # Server setup & routing
│   ├── handlers.go    # HTTP handlers
│   ├── cache.go       # Cache management
│   ├── archive.go     # Archive processing
│   ├── utils.go       # Utility functions
│   ├── go.mod         # Go dependencies
│   ├── litecomics     # Built binary
│   └── public/
